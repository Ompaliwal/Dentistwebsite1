...
import aboutImage from "../assets/about.jpg"; // update the image path
import doctor1 from '../assets/doctor1.jpg';
import doctor2 from '../assets/doctor2.jpg';
import doctor3 from '../assets/doctor3.jpg';
import doctorImage1 from '../assets/contact-doctor.jpg';
...
const AboutUs = () => {
    return (
        <>
            ...
            <section className="py-20 font-jakarta bg-white">
